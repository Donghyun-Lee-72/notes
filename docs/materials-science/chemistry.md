...
science. It is useful as a study guide even while the detailed topic notes are
...
5. **Aqueous Reactions and Net Ionic Equations** *(planned)* — distinguish the
   species present in water and identify the chemical change a reaction
   equation represents.
6. **Redox Foundations and Balancing** *(planned)* — use oxidation states as a
   formal bookkeeping model, identify coupled oxidation and reduction, and
   balance matter and charge.
7. **Thermochemistry and Thermodynamic Direction** *(planned)* — track energy
   changes and distinguish whether a process is thermodynamically favored from
   how fast it occurs.
8. **Equilibrium, Acids/Bases, and Solubility** *(planned)* — analyze reversible
   reactions and coupled solution equilibria under stated conditions.
9. **Kinetics and Reaction Mechanisms** *(planned)* — connect measured reaction
   rates to pathways, temperature, concentration, and catalysis.
10. **Electrochemical Cells, Potential, and Applications** *(planned)* —
